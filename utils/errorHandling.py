...
class IntelligentErrorHandler:
    ...
    def _initialize_tool_alternatives(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            # 🐳 Container Security
            # ------------------------------
            "trivy": ["clair", "docker-bench-security", "kubesec"],
            "clair": ["trivy", "docker-bench-security"],
            "docker-bench-security": ["trivy", "clair"],
            ...
            # ------------------------------
            "kube-bench": ["kubesec", "popeye"],
            "kube-hunter": ["cdk", "popeye"],  
            "kubesec": ["kube-bench", "popeye"],
            "popeye": ["kubesec", "kube-bench"],

            # ------------------------------
            # 🔐 RBAC & Authorization
            # ------------------------------
            "rbac-tool": ["popeye", "kubesec"],

            # ------------------------------
            # ⚔️ Attack Surface / Exploitation
            # ------------------------------
            "cdk": ["kube-hunter", "trivy"],
